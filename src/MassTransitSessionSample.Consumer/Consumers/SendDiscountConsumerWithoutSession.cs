...
{
    public class SendDiscountConsumerWithoutSession : IConsumer<SendDiscount>
    {
        private readonly BlobServiceClient _blobServiceClient;
        public SendDiscountConsumerWithoutSession(BlobServiceClient blobServiceClient)
        {
        ...
        public async Task Consume(ConsumeContext<SendDiscount> context)
        {
            ...
            BlobClient blobClient = containerClient.GetBlobClient($"without-session/{context.Message.Creation.ToString("yyyy-MM-dd-HH-mm-ss-fff")}__{DateTime.UtcNow.ToString("yyyy-MM-dd-HH-mm-ss-fff")}.json");
