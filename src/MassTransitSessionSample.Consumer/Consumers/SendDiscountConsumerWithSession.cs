...
{
    public class SendDiscountConsumerWithSession : IConsumer<SendDiscount>
    {
        private readonly BlobServiceClient _blobServiceClient;
        public SendDiscountConsumerWithSession(BlobServiceClient blobServiceClient)
        {
        ...
        public async Task Consume(ConsumeContext<SendDiscount> context)
        {
            ...
            BlobClient blobClient = containerClient.GetBlobClient($"with-session/{context.Message.Creation.ToString("yyyy-MM-dd-HH-mm-ss-fff")}__{DateTime.UtcNow.ToString("yyyy-MM-dd-HH-mm-ss-fff")}.json");
